...
const StaticElements = () => {
	return (
		<div className=''>
			...
			<button className='fixed bottom-0 p-10 hover:animate-spin text-neutral-content'>
				<RiSettings3Line className='w-5 h-5' />
			</button>
			<a
				className='fixed bottom-0 right-0 p-10 hover:animate-wiggle text-neutral-content'
			...
			<button className='fixed right-0 pr-10 pt-14 hover:animate-pulse text-neutral-content'>
